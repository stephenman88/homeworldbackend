...
public interface CardService {
    ...
    List<CardResponseDTO> getAllCardResponses();
    List<CardDTO> getAllCards();
    Optional<CardResponseDTO> getCardResponseById(String id);
    Optional<CardDTO> getCardById(String id);
    CardDTO convertToDTO(JsonNode cardNode)  throws JsonProcessingException;
    void addOtherOrientationToEdition(JsonNode otherOrientation, Edition edition) throws JsonProcessingException;
    List<CardResponseDTO> getCardResponsesByParameter(
